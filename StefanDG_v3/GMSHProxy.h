...
namespace GMSHProxy
{
    ...
    namespace model
    {
        ...
        namespace mesh
        {
            ...
            void getTrianglesNodes(size_t(*&traianglesNodesTags)[constants::triangle::N_NODES], Coordinates(*&traianglesNodes)[constants::triangle::N_NODES], size_t& nTriangles, const int tag = DEFAULT_TAG);
